...
deckbuilder_i18n.locales.en = {
    ...
    error_cardlist_empty = "Card list is empty! Please paste the list of cards in the text box before submitting the deck.",
    error_csv_url_not_set = "CSV URL is not set! Please set it in settings before submitting the deck.",
    error_cardback_url_not_set = "Card back URL is not set! Please set it in settings before submitting the deck.",
    validation_cards_not_found = "These cards were not found in the list:",
    validation_everything_ok = "Everything OK!",
    validation_results_label = "<b>Validation results:</b>",
    dropdown_create_new = "Create new ...",
    dialog_deck_validation_failed = "This deck did not pass the validation. Are you sure you want to create it?",
    validation_number_of_cards = "Number of cards",
    validation_min_cards = "less than minimum",
    validation_max_cards = "more than maximum",
    validation_unique_is = " is unique, but has ",
    validation_unique_copies = " copies in the list.",
    validation_limit_has = " has ",
    validation_limit_copies = " copies in the list, but limit is ",
    validation_mandatory_card = "Mandatory card ",
    validation_mandatory_missing = " is missing from the list.",
    validation_banned_card = "Banned card ",
    validation_banned_present = " is present in the list.",
...
deckbuilder_i18n.locales.hu = {
    ...
    error_cardlist_empty = "A kártya lista üres! Kérlek, írd be vagy másold be kártyák listáját az alábbi szövegdobozba az elküldés előtt.",
    error_csv_url_not_set = "CSV URL nincs beállítva! Kérlek, állítsd be a Beállítások között az elküldés előtt.",
    error_cardback_url_not_set = "Kártya hátlap URL nincs beállítva! Kérlek, állítsd be a Beállítások között az elküldés előtt.",
    validation_cards_not_found = "Ezek a kártyák nincsenek a listában:",
    validation_everything_ok = "Minden rendben!",
    validation_results_label = "<b>Ellenőrzés eredménye:</b>",
    dropdown_create_new = "Új létrehozása...",
    dialog_deck_validation_failed = "Ez a pakli nem felelt meg az ellenőrzésnek. Biztos, hogy létre akarod hozni?",
    validation_number_of_cards = "A kártyák száma",
    validation_min_cards = "kevesebb, mint a minimum",
    validation_max_cards = "több, mint a maximum",
    validation_unique_is = " egyedi, de van ",
    validation_unique_copies = " másolata a listában.",
    validation_limit_has = " van ",
    validation_limit_copies = " másolata a listában, de a limit ",
    validation_mandatory_card = "Kötelező kártya ",
    validation_mandatory_missing = " hiányzik a listából.",
    validation_banned_card = "Tiltott kártya ",
    validation_banned_present = " jelen van a listában.",
    default_rule_name = "Új szabály",
    button_yes = "Igen",
    button_no = "Nem",
}
